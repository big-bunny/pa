...
__all__ = [
    'OLE_HANDLE', 'OLE_XSIZE_PIXELS', 'OLE_YSIZE_HIMETRIC', 'Checked',
    'OLE_TRISTATE', 'OLE_XPOS_CONTAINER', 'IFontDisp',
    'OLE_YPOS_PIXELS', 'OLE_XSIZE_HIMETRIC', 'StdPicture', 'Gray',
    'Color', 'IFont', 'OLE_OPTEXCLUSIVE', 'FONTUNDERSCORE',
    'OLE_XPOS_HIMETRIC', 'FontEvents', 'OLE_YPOS_CONTAINER',
    'FONTITALIC', 'Monochrome', 'FONTNAME', 'Font', 'Default',
    'OLE_YPOS_HIMETRIC', 'OLE_YSIZE_PIXELS', 'IPicture', 'StdFont',
    'IPictureDisp', 'Unchecked', 'OLE_XPOS_PIXELS', 'OLE_CANCELBOOL',
    'OLE_YSIZE_CONTAINER', 'OLE_COLOR', 'FONTSTRIKETHROUGH',
    'FONTSIZE', 'OLE_XSIZE_CONTAINER', 'IFontEventsDisp', 'FONTBOLD',
    'LoadPictureConstants', 'Picture', 'OLE_ENABLEDEFAULTBOOL',
    'VgaColor'
]

_check_version('1.2.0', 1552970625.570791)

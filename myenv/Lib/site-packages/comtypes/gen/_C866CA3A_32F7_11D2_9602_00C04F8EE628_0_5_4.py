...
__all__ = [
    'SASStop', 'SPEI_PHONEME', 'DISPID_SRGetPropertyNumber',
    'SPTEXTSELECTIONINFO', 'ISpeechLexiconPronunciations',
    'eLEXTYPE_RESERVED8', 'SAFT48kHz8BitMono', 'SPINTERFERENCE_NONE',
    'DISPID_SRRTTickCount', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPBINARYGRAMMAR', 'DISPID_SRCEEnginePrivate',
    'DISPID_SASCurrentSeekPosition', 'STCAll', 'SpCustomStream',
    'SpeechDictationTopicSpelling', 'SVESentenceBoundary',
    'SGRSTTRule', 'SVP_4', 'DISPID_SPEsItem', 'SPAUDIOSTATE',
    'SpeechRecoProfileProperties', 'DISPID_SDKSetStringValue',
    'SAFT24kHz8BitMono', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SOTCDefault', 'ISpeechPhraseElements',
    'DISPID_SpeechPhraseProperty', 'SPAO_NONE', 'SRERecognition',
    'eLEXTYPE_RESERVED6', 'SpeechPropertyAdaptationOn',
    'SPEI_UNDEFINED', 'SAFT24kHz16BitMono',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRAudioInputStream', 'DISPID_SpeechObjectTokens',
    'DISPIDSPTSI_ActiveLength', 'ISpeechRecoResultTimes',
    'DISPID_SASCurrentDevicePosition', 'SpeechAudioFormatGUIDWave',
    'DISPID_SGRSTsCount', 'DISPID_SRCResume', 'SPAS_STOP',
    'SPSFunction', 'SpeechAudioFormatGUIDText', 'SPEI_TTS_PRIVATE',
    'ISpEventSource', 'DISPID_SMSGetData', 'IEnumString',
    'SP_VISEME_16', 'SAFT11kHz8BitStereo', 'DISPID_SLWs_NewEnum',
    'DISPID_SRCERecognitionForOtherContext', 'SPAS_PAUSE',
    'SRAExport', 'SREBookmark', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SVEWordBoundary', 'SRSInactiveWithPurge', 'ISpeechRecoGrammar',
    'SpeechDataKeyLocation', 'DISPID_SRCEStartStream',
    'SPPHRASEPROPERTY', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'ISpeechFileStream', 'DISPID_SpeechPhraseRule', 'DISPID_SAStatus',
    'SpNullPhoneConverter', 'SP_VISEME_6', 'SAFTGSM610_22kHzMono',
    'DISPID_SVSLastResult', 'SPRST_ACTIVE',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SBSRead',
    'DISPID_SLWLangId', 'DISPID_SpeechRecoContextEvents', 'SVP_11',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SVSPhonemeId',
    'DISPID_SDKGetStringValue', 'SAFT22kHz8BitMono', 'SVSFIsFilename',
    'SREAudioLevel', 'SRATopLevel', 'DISPID_SpeechPhraseInfo',
    'DISPID_SFSClose', 'DISPID_SRCEAdaptation',
    'DISPID_SRCEFalseRecognition', 'ISpeechCustomStream',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPPS_Modifier',
    'DISPID_SpeechRecoResultTimes', 'SBONone',
    '__MIDL_IWinTypes_0009', 'SPSERIALIZEDPHRASE',
    'SPWORDPRONOUNCEABLE', 'ISpeechLexiconWord',
    'DISPID_SRCERecognition', 'SpLexicon', 'SINoise', 'SPCT_COMMAND',
    'SPDKL_DefaultLocation', 'SAFT48kHz16BitMono',
    'SDA_No_Trailing_Space', 'SPEI_ADAPTATION',
    'DISPID_SpeechRecoResult2', 'DISPID_SpeechDataKey', 'SRTReSent',
    'DISPID_SLPsItem', 'SPPS_RESERVED1', 'DISPID_SPIEngineId',
    'DISPID_SGRSTNextState', 'DISPID_SGRsItem',
    'DISPID_SPEActualConfidence', 'DISPID_SLWWord',
    'DISPID_SRCBookmark', 'DISPID_SPPsItem', 'SPPS_Unknown',
    'ISpObjectTokenCategory', 'DISPID_SRSCurrentStreamNumber',
    'ISpNotifySink', 'DISPID_SpeechPhraseProperties',
    'ISpeechRecognizerStatus', 'IInternetSecurityMgrSite',
    'SPEI_SR_RETAINEDAUDIO', 'ISpEventSink', 'SPSMF_UPS',
    'eLEXTYPE_PRIVATE18', 'eLEXTYPE_PRIVATE15',
    'ISpeechGrammarRuleStateTransitions',
    'SpeechPropertyResponseSpeed', 'ISpeechRecoResult',
    'SpInprocRecognizer', 'DISPID_SRGDictationUnload',
    'SPSERIALIZEDRESULT', 'SWTDeleted', 'ISpeechLexiconWords',
    'SDKLCurrentUser', 'DISPID_SPIGetText', 'ISpeechRecoResult2',
    'SSFMOpenForRead', 'SPSHT_EMAIL', 'DISPID_SLAddPronunciation',
    'DISPID_SOTId', 'DISPID_SOTsItem', 'SDKLCurrentConfig',
    'SPFM_CREATE', 'SRESoundEnd', 'SBOPause', 'SAFTDefault',
    'SECFIgnoreWidth', 'SAFT48kHz16BitStereo',
    'DISPID_SABIMinNotification', 'SpeechInterference',
    'DISPID_SPERetainedSizeBytes', 'SECLowConfidence',
    'DISPID_SRGCmdLoadFromResource', 'SSTTWildcard',
    'SAFTADPCM_8kHzStereo', 'SpeechBookmarkOptions',
    'SpeechStreamSeekPositionType', 'DISPID_SWFEBitsPerSample',
    'DISPID_SRDisplayUI', 'SPSNotOverriden', 'DISPID_SVDisplayUI',
    'SPFM_OPEN_READONLY', 'DISPID_SMSSetData',
    'ISpeechPhraseReplacement', 'DISPID_SRRTStreamTime', 'ISpLexicon',
    'DISPID_SOTGetStorageFileName', 'ISpResourceManager', 'SVP_5',
    'SpeechCategoryAudioOut', 'DISPID_SDKDeleteKey', 'SpObjectToken',
    'DISPID_SpeechRecoResult', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SRGRules', 'SVEPrivate',
    'SpeechPropertyNormalConfidenceThreshold', 'SAFTGSM610_11kHzMono',
    'SAFT44kHz8BitMono', 'DISPID_SLGetPronunciations', 'SINoSignal',
    'DISPID_SpeechPhraseElements', 'DISPID_SRAudioInput',
    'DISPID_SGRSAddWordTransition', 'DISPID_SGRsAdd',
    'SpeechEngineProperties', 'SpeechCategoryPhoneConverters',
    'SRSActive', 'ISpObjectToken', 'DISPID_SPAStartElementInResult',
    'SVSFUnusedFlags', 'SASPause', 'SGDisplay', 'DISPID_SRCPause',
    'eLEXTYPE_RESERVED4', 'SVPAlert', 'DISPID_SpeechAudio',
    'SPRECORESULTTIMES', 'SAFT44kHz16BitStereo',
    'DISPID_SRCESoundStart', 'SFTSREngine', 'SSSPTRelativeToStart',
    'SPVPRI_NORMAL', 'DISPID_SRCRetainedAudio',
    'DISPID_SRGCmdSetRuleState', 'SPGS_DISABLED',
    'DISPID_SPILanguageId', 'DISPID_SGRId', 'SpeechAllElements',
    'SPEI_TTS_AUDIO_LEVEL', 'STSF_AppData', 'SAFT11kHz16BitStereo',
    'DISPID_SGRSTPropertyId', 'SAFTText', 'SP_VISEME_2',
    'SECFIgnoreKanaType', 'SP_VISEME_14',
    'SDA_Consume_Leading_Spaces', 'SpeechVoiceSpeakFlags',
    'SPSHT_NotOverriden', 'DISPID_SVPriority', 'SPEI_RESERVED3',
    'DISPID_SRCVoice', 'DISPID_SGRSRule', 'SVP_3', 'SPSEMANTICFORMAT',
    'DISPID_SPRuleFirstElement', 'DISPID_SCSBaseStream',
    'ISpeechResourceLoader', 'DISPID_SpeechLexiconWords',
    'SPAUDIOSTATUS', 'SPAO_RETAIN_AUDIO', 'SSFMOpenReadWrite',
    'DISPID_SpeechRecoContext', 'DISPID_SPPValue', 'SP_VISEME_9',
    'ISpeechVoice', 'SPSLMA', 'SpeechGrammarRuleStateTransitionType',
    'eLEXTYPE_RESERVED7', 'DISPID_SLPSymbolic',
    'DISPID_SGRAttributes', 'SPEI_TTS_BOOKMARK', 'SpeechPartOfSpeech',
    'DISPID_SGRSTWeight', 'SpeechDisplayAttributes',
    'DISPID_SPRsItem', 'SSTTDictation', 'DISPID_SREmulateRecognition',
    'eLEXTYPE_PRIVATE13', 'SPEI_START_INPUT_STREAM',
    'DISPID_SpeechPhraseReplacement', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SRGetRecognizers', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SWFESamplesPerSec', 'SPEI_VOICE_CHANGE',
    'SpeechRecognizerState', 'ISpeechRecognizer', 'SpMMAudioEnum',
    'SSSPTRelativeToEnd', 'DISPID_SRSCurrentStreamPosition',
    'SpeechVoiceSkipTypeSentence', 'SPRS_INACTIVE', 'SPPHRASEELEMENT',
    'ISpeechPhraseRule', 'DISPID_SGRsDynamic', 'SAFT16kHz8BitMono',
    'SPPARTOFSPEECH', 'SPFILEMODE', 'SpeechTokenKeyFiles',
    'eLEXTYPE_PRIVATE2', 'SPEI_MIN_SR', 'SPLO_STATIC',
    'DISPID_SpeechMemoryStream', 'DISPID_SRGIsPronounceable',
    'ISpeechAudio', 'SAFT8kHz8BitMono',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SRGDictationSetState',
    'DISPID_SAFGetWaveFormatEx', 'ISpRecoGrammar2', 'SPCT_DICTATION',
    'DISPID_SPRFirstElement', 'SVEStartInputStream', 'SRSEDone',
    'SPPS_RESERVED3', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SpeechPhoneConverter', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SpeechAudioFormat', 'DISPID_SPPName', 'SP_VISEME_17',
    'SVEBookmark', 'SDKLDefaultLocation', 'SVEVoiceChange',
    'DISPID_SpeechPhraseElement', 'DISPID_SAFGuid',
    'DISPID_SpeechAudioBufferInfo', 'SpeechDiscardType',
    'SpeechRegistryUserRoot', 'SRSInactive', 'SpeechTokenShellFolder',
    'SpMMAudioIn', 'DISPID_SPRuleEngineConfidence', 'SRADynamic',
    'DISPID_SLWType', 'DISPID_SRRSetTextFeedback', 'DISPID_SLPType',
    'DISPID_SOTIsUISupported', 'SAFTADPCM_22kHzStereo',
    'SPEI_RECOGNITION', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFT12kHz16BitMono', 'SAFTADPCM_44kHzMono', 'DISPID_SGRsCommit',
    'SpStreamFormatConverter', 'SpeechRecognitionType',
    'SPLEXICONTYPE', 'DISPID_SRGRecoContext',
    'DISPID_SRGCmdLoadFromObject', 'SPWT_PRONUNCIATION',
    'DISPID_SVGetProfiles', 'DISPID_SRSSupportedLanguages', 'SVP_1',
    'eLEXTYPE_PRIVATE19', '_SPAUDIOSTATE', 'SpeechCategoryAudioIn',
    'DISPID_SRCRecognizer', 'SRAONone', 'SPDKL_CurrentConfig',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SDKOpenKey',
    'ISpObjectWithToken', 'SpeechAudioProperties', 'SINone',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'eLEXTYPE_PRIVATE14',
    'DISPID_SRRTLength', 'DISPID_SGRsFindRule',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPEI_SENTENCE_BOUNDARY',
    'SDTLexicalForm', 'SPWORDLIST', 'SP_VISEME_13',
    'DISPID_SVAlertBoundary', 'SP_VISEME_19', 'SP_VISEME_5',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPCT_SUB_DICTATION',
    'DISPID_SPIGrammarId', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPEI_MAX_SR', 'ISpeechRecoResultDispatch', 'SPDATAKEYLOCATION',
    'SPINTERFERENCE_TOOQUIET', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SVEPhoneme', 'SGRSTTEpsilon', 'SPEI_HYPOTHESIS',
    'SAFTExtendedAudioFormat', 'SAFT16kHz16BitMono',
    'DISPID_SBSFormat', 'DISPID_SRGDictationLoad', 'SpeechRecoEvents',
    'SSFMCreate', 'DISPID_SABIEventBias', 'DISPID_SPIRule',
    'DISPID_SRGSetWordSequenceData', 'SVP_0',
    'DISPID_SOTRemoveStorageFileName', 'SVP_13', 'SGRSTTTextBuffer',
    'DISPID_SVStatus', 'DISPID_SVSpeakCompleteEvent', 'SLTApp',
    'SREAdaptation', 'DISPID_SRCEPropertyStringChange', 'ISpShortcut',
    'SPPS_RESERVED4', 'SAFTADPCM_22kHzMono', 'eLEXTYPE_PRIVATE3',
    'SVSFNLPMask', 'SpCompressedLexicon', 'SRAImport', 'SPEI_MAX_TTS',
    'SDTProperty', 'DISPID_SVResume', 'SPEI_END_INPUT_STREAM',
    'SPGS_ENABLED', 'ISpDataKey', 'SECFDefault', 'eLEXTYPE_RESERVED9',
    'ISpeechObjectTokens', 'SAFT12kHz8BitStereo', 'SRSActiveAlways',
    'SPWORDPRONUNCIATION', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SRCEInterference',
    'ISpPhoneConverter', 'DISPID_SASState', 'SPPS_RESERVED2',
    'ISpPhrase', 'SpeechAudioState', 'SVP_19', 'SFTInput',
    'eLEXTYPE_VENDORLEXICON', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SVSFParseSapi', 'ISpXMLRecoResult',
    'DISPID_SVSLastStreamNumberQueued', 'SGPronounciation',
    'DISPID_SRGState', 'SDTPronunciation', 'SP_VISEME_21',
    'DISPID_SAVolume', 'ISpeechGrammarRules',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SGRSTsItem',
    'DISPID_SRCERequestUI', 'DISPID_SDKCreateKey',
    'DISPID_SPIAudioSizeTime', 'SpeechUserTraining',
    'ISpRecoContext2', 'SPCONTEXTSTATE', 'DISPID_SRSetPropertyString',
    'DISPID_SRGetPropertyString', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SPRuleConfidence', 'DISPID_SRRAudio', 'SPSModifier',
    'SPAR_Medium', 'SGLexical', 'SAFT11kHz8BitMono',
    'SAFT22kHz16BitStereo', 'IStream', 'DISPID_SRCEBookmark',
    'SVSFVoiceMask', 'SAFTCCITT_uLaw_44kHzMono',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SPRuleId',
    'DISPID_SVSVisemeId', 'SAFTADPCM_8kHzMono',
    'DISPID_SpeechRecognizer', 'SPEI_RESERVED1', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRRRecoContext', 'SPWORDPRONUNCIATIONLIST',
    'SAFTCCITT_uLaw_44kHzStereo', 'SAFTADPCM_11kHzStereo',
    'SITooSlow', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SGRAddResource', 'SpeechWordType',
    'SAFTNonStandardFormat', 'SPRST_INACTIVE_WITH_PURGE',
    'SAFTNoAssignedFormat', 'DISPID_SRRPhraseInfo',
    'SPAUDIOBUFFERINFO', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SGRName', 'SASRun', 'DISPID_SPERetainedStreamOffset',
    'SPGRAMMARWORDTYPE', 'DISPID_SPRs_NewEnum',
    'DISPID_SpeechLexiconWord', 'ISpRecognizer3', 'SREInterference',
    'SPPS_Function', 'SpAudioFormat', 'DISPID_SOTCId',
    'SAFT48kHz8BitStereo', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRIsUISupported', 'ISpeechAudioFormat',
    'ISpeechPhraseInfoBuilder', 'DISPID_SABufferInfo', 'SPAS_RUN',
    'DISPID_SABIBufferSize', 'SPCS_DISABLED', 'SPEI_START_SR_STREAM',
    'SRARoot', 'ISpStreamFormatConverter', 'SWTAdded',
    'DISPID_SLPPartOfSpeech', 'DISPID_SOTCGetDataKey',
    'DISPID_SpeechCustomStream', 'SpeechRuleAttributes',
    'SPFM_CREATE_ALWAYS', 'SpeechTokenKeyAttributes',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SWFEExtraData',
    'SDKLLocalMachine', 'SPPS_Noncontent', 'SPRECOCONTEXTSTATUS',
    'SPEI_WORD_BOUNDARY', 'DISPID_SOTDisplayUI', 'SPVPRIORITY',
    'DISPID_SASetState', 'DISPID_SpeechPhraseAlternates',
    'ISpStreamFormat', 'DISPID_SVSInputWordLength',
    'ISpGrammarBuilder', 'DISPID_SPPChildren',
    'ISpeechObjectTokenCategory', 'SVEViseme',
    'DISPID_SpeechVoiceEvent', 'SpeechVoiceEvents',
    'SpSharedRecognizer', 'SRADefaultToActive',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPAsCount', 'DISPID_SBSSeek', 'ISpeechPhraseInfo',
    'DISPID_SOTRemove', 'SVEAllEvents', 'SPINTERFERENCE_TOOFAST',
    'SPAR_Unknown', 'SPEI_INTERFERENCE', 'DISPID_SWFEAvgBytesPerSec',
    'SpeechPropertyComplexResponseSpeed', 'SGLexicalNoSpecialChars',
    'SpeechTokenIdUserLexicon', 'DISPID_SRCEAudioLevel',
    'SPEI_RESERVED2', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SPPEngineConfidence', 'SPINTERFERENCE_TOOSLOW',
    'SGDSActiveWithAutoPause', 'SpeechGrammarWordType',
    'DISPID_SGRSTransitions', 'DISPID_SRState',
    'DISPID_SVIsUISupported', 'SpeechTokenKeyUI', 'eWORDTYPE_DELETED',
    'DISPID_SOTCSetId', 'ISpPhoneticAlphabetConverter',
    'ISpPhraseAlt', 'SP_VISEME_3', 'SPAR_Low', 'SVEAudioLevel',
    'DISPID_SAEventHandle', 'SITooFast', 'DISPID_SPEsCount',
    'DISPID_SPEAudioSizeBytes', 'SPEVENTSOURCEINFO',
    'DISPID_SRRGetXMLResult', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SVF_None', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SAFType',
    'SPVPRI_OVER', 'SPSHORTCUTTYPE',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPPHRASERULE',
    'DISPID_SRRAlternates', 'SpeechGrammarTagDictation',
    'SWPUnknownWordUnpronounceable', 'SPWF_SRENGINE',
    'SpeechPropertyLowConfidenceThreshold', 'eLEXTYPE_PRIVATE16',
    'SPAR_High', 'SRTEmulated', 'ISpStream', 'SLODynamic',
    'SRTExtendableParse', 'SpeechCategoryVoices',
    'DISPID_SPIReplacements', 'DISPID_SGRAddState',
    'SpNotifyTranslator', 'DISPID_SPEAudioTimeOffset',
    'ISpNotifySource', 'ISpeechAudioStatus',
    'DISPID_SpeechGrammarRules', 'DISPID_SPEEngineConfidence',
    'DISPID_SPIStartTime', 'SPBO_TIME_UNITS', 'SpeechGrammarState',
    'eLEXTYPE_MORPHOLOGY', 'SAFT32kHz16BitStereo',
    'SPPS_NotOverriden', 'SpeechGrammarTagWildcard',
    'DISPID_SWFEFormatTag', 'DISPID_SPIProperties', 'DISPID_SPAsItem',
    'SpeechWordPronounceable', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SPCIdToPhone', 'SpeechLexiconType',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SGDSActive',
    'SVEEndInputStream', 'SPLOADOPTIONS', 'SAFTGSM610_8kHzMono',
    'SVP_10', 'SVP_21', 'DISPID_SPIRetainedSizeBytes',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPGRAMMARSTATE', 'SPSVerb',
    'ISpRecoGrammar', 'ISpeechPhoneConverter',
    'DISPID_SpeechLexiconProns', 'DISPID_SPRules_NewEnum',
    'SRAInterpreter', 'Speech_StreamPos_Asap',
    'DISPID_SPPBRestorePhraseFromMemory', 'eLEXTYPE_USER',
    'DISPID_SPIElements', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRGId', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SPEDisplayText', 'SLTUser', 'SECHighConfidence',
    'SAFTCCITT_ALaw_8kHzMono', 'Speech_StreamPos_RealTime',
    'SpeechVisemeFeature', 'SPDKL_CurrentUser',
    'ISpeechPhraseAlternate', 'ISpeechMMSysAudio', 'DISPID_SRProfile',
    'DISPID_SVEBookmark', 'DISPID_SPRsCount',
    'DISPID_SRCRequestedUIType', 'IInternetSecurityManager',
    'SGRSTTDictation', 'SAFTCCITT_uLaw_8kHzMono',
    'SPEI_RECO_STATE_CHANGE', '_RemotableHandle', 'SGSExclusive',
    'SAFT44kHz16BitMono', 'SpUnCompressedLexicon',
    'DISPID_SPRNumberOfElements', 'DISPID_SVRate', 'DISPID_SRCState',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SpeechPhraseReplacements',
    'SDA_Two_Trailing_Spaces', 'SVSFParseMask',
    'DISPID_SVAudioOutputStream', 'DISPID_SPAPhraseInfo',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SVSInputWordPosition',
    'SP_VISEME_4', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SPEDisplayAttributes', 'SAFTADPCM_44kHzStereo',
    'tagSPTEXTSELECTIONINFO', 'ISpeechXMLRecoResult',
    'eLEXTYPE_PRIVATE10', 'ISpAudio', 'STCInprocHandler',
    'eLEXTYPE_PRIVATE8', 'SVSFParseAutodetect', 'SVP_16',
    'DISPID_SRRSpeakAudio', 'DISPID_SVVolume', 'DISPID_SPPsCount',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SLWsCount',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPAs_NewEnum',
    'DISPID_SLGenerationId', 'DISPID_SpeechAudioStatus',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SRGCmdLoadFromMemory',
    'SPBO_NONE', 'SAFT32kHz16BitMono', 'DISPID_SRCreateRecoContext',
    'SPBOOKMARKOPTIONS', 'SAFT24kHz16BitStereo', 'SPAUDIOOPTIONS',
    'DISPID_SVSkip', 'SAFTADPCM_11kHzMono', 'DISPIDSPTSI',
    'DISPID_SVSpeakStream', 'SpeechSpecialTransitionType',
    'STSF_LocalAppData', 'DISPID_SOTCEnumerateTokens',
    'SPEI_SR_PRIVATE', 'UINT_PTR', 'ISpeechAudioBufferInfo',
    'SpeechEmulationCompareFlags', 'SpResourceManager', 'SDTRule',
    'DISPID_SVSLastBookmarkId', 'DISPID_SPPNumberOfElements',
    'SpeechVoicePriority', 'SPCS_ENABLED', 'SAFT8kHz8BitStereo',
    'STSF_CommonAppData', 'SVF_Emphasis', 'SPEI_RESERVED6',
    'DISPID_SLPsCount', 'SpPhoneConverter',
    'DISPID_SpeechPhraseAlternate', 'SpPhoneticAlphabetConverter',
    'SPSEMANTICERRORINFO', 'DISPID_SRSClsidEngine',
    'eLEXTYPE_PRIVATE11', 'eLEXTYPE_PRIVATE12',
    'DISPID_SDKSetBinaryValue', 'SVSFParseSsml',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SP_VISEME_10',
    'ISpeechGrammarRule', 'DISPID_SRRSaveToMemory', 'SREStreamEnd',
    'DISPID_SASNonBlockingIO', 'DISPID_SRCERecognizerStateChange',
    'SP_VISEME_1', 'ISpRecognizer', 'DISPID_SADefaultFormat',
    'SPEVENTENUM', 'SPEI_FALSE_RECOGNITION', 'DISPID_SGRInitialState',
    'DISPID_SPRText', 'SPLO_DYNAMIC', 'DISPID_SVGetAudioOutputs',
    'DISPID_SDKGetlongValue', 'SpeechCategoryRecoProfiles',
    'SPXRO_SML', 'DISPID_SWFEBlockAlign', 'SPPS_Noun',
    'DISPID_SOTDataKey', 'SREPhraseStart', 'DISPID_SGRSTPropertyName',
    'DISPID_SGRSTType', 'DISPID_SpeechPhraseRules',
    'SAFTCCITT_uLaw_8kHzStereo', 'SAFT8kHz16BitMono',
    'DISPID_SGRsCommitAndSave', 'DISPID_SPEs_NewEnum',
    'Speech_Max_Pron_Length', 'SpeechLoadOption',
    'DISPID_SVAudioOutput', 'DISPID_SDKEnumValues', 'SDTAudio',
    'eLEXTYPE_PRIVATE6', 'SPXRO_Alternates_SML',
    'DISPID_SpeechGrammarRuleState', 'ISpPhoneticAlphabetSelection',
    'SRESoundStart', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SVP_2', 'eLEXTYPE_PRIVATE7', 'SPVPRI_ALERT',
    'DISPID_SRGCmdLoadFromFile', 'SAFT24kHz8BitStereo',
    'SpeechStreamFileMode', 'SpFileStream',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SRCEventInterests',
    'SECNormalConfidence', 'ISpeechPhraseProperties',
    'eLEXTYPE_PRIVATE20', 'SPBO_PAUSE', 'eLEXTYPE_USER_SHORTCUT',
    'SAFT11kHz16BitMono', 'DISPID_SVSLastBookmark',
    'DISPID_SLRemovePronunciation', 'eLEXTYPE_APP',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SPPs_NewEnum',
    'DISPID_SRCCreateGrammar', 'tagSPPROPERTYINFO',
    'DISPID_SLGetWords', 'SPDKL_LocalMachine',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SpeechFileStream',
    'ISpRecoResult', 'DISPID_SOTCreateInstance', 'SPEI_PHRASE_START',
    'DISPID_SVWaitUntilDone', 'DISPID_SPPConfidence',
    'ISpeechPhraseElement', 'DISPID_SDKDeleteValue', 'SVPOver',
    'SP_VISEME_11', 'SREPropertyNumChange', 'SRCS_Disabled',
    'SRERequestUI', 'SpStream', 'SREPropertyStringChange',
    'DISPID_SVSCurrentStreamNumber', 'ISpeechDataKey',
    'SpeechPropertyResourceUsage', 'ISpeechGrammarRuleState',
    '_ISpeechVoiceEvents', 'SPSNoun', 'SGDSInactive',
    ...
    'SAFT16kHz8BitStereo', 'DISPID_SLPLangId', 'STCLocalServer',
    'SGSDisabled', 'SPWORDTYPE', 'ISpNotifyTranslator', 'SPRULESTATE',
    'DISPID_SLGetGenerationChange', '_ISpeechRecoContextEvents',
    'SPCT_SUB_COMMAND', 'SREHypothesis',
    'DISPID_SPIEnginePrivateData', 'DISPID_SVPause',
    'DISPID_SLWPronunciations', 'ISpRecoCategory', 'SpMemoryStream',
    'SPAS_CLOSED', 'ISpSerializeState', 'SPRULE',
    'SAFTCCITT_ALaw_44kHzStereo', 'SVP_15',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SRGetFormat',
    'DISPID_SLPs_NewEnum', 'Speech_Default_Weight',
    'DISPID_SDKEnumKeys', 'DISPID_SGRClear', 'SDTReplacement',
    'SAFT12kHz8BitMono', 'DISPID_SRCEEndStream', 'DISPID_SPRuleName',
    'ISpeechObjectToken', 'DISPID_SABufferNotifySize',
    'DISPID_SVSRunningState', 'DISPID_SMSAMMHandle',
    'SAFT16kHz16BitStereo', 'SpeechVisemeType', 'ISpRecognizer2',
    'SPPS_LMA', 'SGRSTTWord', 'SVSFPersistXML', 'SpPhraseInfoBuilder',
    'DISPID_SVGetAudioInputs', 'SPFM_OPEN_READWRITE',
    'ISpeechPhraseRules', 'SpeechRecoContextState',
    ...
    'ISpeechGrammarRuleStateTransition', 'SPEI_MIN_TTS',
    'DISPID_SVEVoiceChange', 'DISPID_SLPPhoneIds',
    'DISPID_SRSAudioStatus', 'SP_VISEME_15',
    'DISPID_SpeechGrammarRule', 'DISPID_SMSADeviceId', 'SVP_7',
    'SpVoice', 'SPRST_NUM_STATES', 'SRSEIsSpeaking',
    'IEnumSpObjectTokens', 'SPSUnknown', 'SAFT12kHz16BitStereo',
    'DISPID_SVVoice', 'DISPID_SRCVoicePurgeEvent', 'DISPID_SRGCommit',
    'SPPS_SuppressWord', 'SDTAlternates', 'ISpeechPhraseProperty',
    'DISPID_SASFreeBufferSpace', 'SPSSuppressWord',
    'DISPID_SPELexicalForm', 'SECFNoSpecialChars',
    'SPPS_Interjection', 'SITooQuiet', 'SREStreamStart',
    'SWPUnknownWordPronounceable', 'DISPID_SFSOpen',
    'ISpeechLexiconPronunciation', 'DISPID_SGRsCount',
    'SREFalseRecognition', 'SPINTERFERENCE', 'SSTTTextBuffer',
    'DISPID_SRCEPhraseStart', 'SVSFPurgeBeforeSpeak', 'SPWT_DISPLAY',
    'SRERecoOtherContext', 'SpShortcut', 'DISPID_SVSpeak',
    'SpeechAddRemoveWord', 'DISPID_SAFSetWaveFormatEx',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SDKSetLongValue',
    'ISpeechBaseStream', 'SPWAVEFORMATTYPE', 'SPPS_Verb',
    'DISPID_SMSALineId', 'SGSEnabled', 'eLEXTYPE_RESERVED10',
    'ISpeechRecoContext', 'SpeechTokenValueCLSID', 'LONG_PTR',
    'DISPID_SPPFirstElement', 'SRTAutopause', 'DISPID_SRCESoundEnd',
    'SREStateChange', 'STSF_FlagCreate', 'SAFTCCITT_ALaw_22kHzMono',
    'tagSTATSTG', 'SpeechCategoryAppLexicons', 'eLEXTYPE_PRIVATE9',
    'SPEI_PROPERTY_NUM_CHANGE', 'SAFT22kHz8BitStereo',
    'DISPID_SVGetVoices', 'DISPID_SPRulesCount',
    'DISPID_SRCEHypothesis', 'SpMMAudioOut', 'SVSFIsNotXML',
    'SPSHT_OTHER', 'ISpeechPhraseReplacements', 'SP_VISEME_20',
    'DISPID_SRCSetAdaptationData', 'SPSHORTCUTPAIR', 'SRTSMLTimeout',
    'SVEPhoneme', 'DISPID_SRGSetTextSelection', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SVEAudioLevel', 'ISequentialStream', 'SPXMLRESULTOPTIONS',
    'SPEI_REQUEST_UI', 'SAFT32kHz8BitMono', 'DISPID_SOTGetAttribute',
    'SSFMCreateForWrite', 'ISpeechTextSelectionInformation',
    'DISPID_SVEventInterests', 'DISPID_SPRulesItem',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRRecognizer',
    'SP_VISEME_7', 'DISPID_SBSWrite', 'eLEXTYPE_PRIVATE17',
    'STCRemoteServer', 'DISPID_SpeechMMSysAudio', 'DISPID_SOTsCount',
    'DISPID_SOTCategory', 'SpeechPropertyHighConfidenceThreshold',
    'SVSFIsXML', 'SPWF_INPUT', 'DISPIDSPRG', 'SVP_14',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SWFEChannels',
    'SPGS_EXCLUSIVE', 'DISPID_SPACommit', 'DISPID_SDKGetBinaryValue',
    'SpSharedRecoContext', 'DISPID_SVEStreamStart',
    'SAFTGSM610_44kHzMono', 'SPWT_LEXICAL', 'SP_VISEME_12',
    'SPVISEMES', 'DISPID_SpeechVoice', 'ISpeechMemoryStream',
    'DISPID_SOTs_NewEnum', 'DISPID_SGRSTText', 'ISpeechLexicon',
    'DISPID_SPRuleParent', 'SPRST_INACTIVE', 'SpInProcRecoContext',
    'SpeechEngineConfidence', 'SpeechAudioVolume', 'SPEI_SR_BOOKMARK',
    'SREAllEvents', 'SPBO_AHEAD', 'SVP_20',
    'SpeechCategoryRecognizers', 'SAFT44kHz8BitStereo',
    'DISPID_SRIsShared', 'DISPID_SVEViseme', 'SPCATEGORYTYPE',
    'SGRSTTWildcard', 'SPRS_ACTIVE', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SVEEnginePrivate', 'SREPrivate',
    'SGDSActiveUserDelimited', 'SAFT22kHz16BitMono',
    'DISPID_SPCLangId', 'DISPID_SPEPronunciation', 'SPPROPERTYINFO',
    'SpObjectTokenCategory', 'SVP_12', 'DISPID_SOTGetDescription',
    'SVP_8', 'SPRECOGNIZERSTATUS', 'ISpeechVoiceStatus',
    'eWORDTYPE_ADDED', 'SVPNormal', 'DISPID_SRGReset', 'ISpVoice',
    'SP_VISEME_0', 'DISPID_SRRTOffsetFromStart', 'SP_VISEME_18',
    'SASClosed', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SpeechWaveFormatEx', 'SDTAll',
    'DISPID_SRRGetXMLErrorInfo', 'ISpeechWaveFormatEx',
    'SVSFNLPSpeakPunc', 'SP_VISEME_8', 'DISPID_SGRSTRule', 'SVP_9',
    'DISPID_SPRDisplayAttributes', 'DISPID_SLWsItem',
    'SpTextSelectionInformation', 'SPWORD', 'SRCS_Enabled',
    'ISpProperties', 'SPINTERFERENCE_NOSIGNAL', 'SRAORetainAudio',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SpeechBaseStream', 'SPADAPTATIONRELEVANCE',
    'SPEI_SOUND_END', 'SPVOICESTATUS', 'SpeechRuleState',
    'ISpeechPhraseAlternates', 'DISPID_SPCPhoneToId',
    'Speech_Max_Word_Length', 'DISPID_SGRSAddRuleTransition',
    'SpeechRetainedAudioOptions', 'eLEXTYPE_PRIVATE4',
    'DISPID_SVEStreamEnd', 'SDA_One_Trailing_Space',
    'SpeechTokenContext', 'SITooLoud', 'ISpRecoContext',
    'DISPID_SOTSetId', 'DISPID_SGRs_NewEnum', 'SPSTREAMFORMATTYPE',
    'SPSMF_SAPI_PROPERTIES', 'SPCT_SLEEP', 'SpeechMicTraining',
    'SVSFlagsAsync', 'SAFT32kHz8BitStereo', 'SVF_Stressed',
    'DISPID_SpeechVoiceStatus', 'DISPID_SpeechLexicon',
    'ISpMMSysAudio', 'SPFM_NUM_MODES', 'DISPID_SRRTimes',
    'eLEXTYPE_PRIVATE1', 'DISPID_SVEWord', 'DISPID_SpeechObjectToken',
    'SVP_6', 'DISPID_SPISaveToMemory', 'SpeechRunState',
    'DISPID_SOTMatchesAttributes', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRRAudioFormat',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVP_18',
    'DISPID_SRRDiscardResultInfo', 'SPEI_RESERVED5',
    'DISPIDSPTSI_ActiveOffset', 'SpWaveFormatEx',
    'DISPID_SPARecoResult', 'SpeechFormatType', 'STCInprocServer',
    'WAVEFORMATEX', 'SDTDisplayText', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SPIGetDisplayAttributes', 'SPSHT_Unknown', 'SPEVENT',
    'SPINTERFERENCE_NOISE', 'SPRECOSTATE',
    'DISPID_SPANumberOfElementsInResult', 'SVP_17', 'DISPID_SPPId',
    'SVSFDefault', 'SPEI_VISEME', 'SPEI_END_SR_STREAM',
    'DISPID_SPIAudioStreamPosition', 'SPEI_SOUND_START', 'SPPHRASE',
    'SpeechAudioFormatType', 'SECFEmulateResult', 'SRTStandard',
    'DISPID_SRStatus', 'SPSInterjection',
    'DISPID_SPERequiredConfidence', 'SECFIgnoreCase'
]

_check_version('1.2.0', 1552970670.676671)
